...
if(circleMatrix[CircCenterCounter-rand1].vars.x > 100 && circleMatrix[CircCenterCounter-rand1].vars.x < 500){
    r.line(circleMatrix[CircCenterCounter-rand1].vars.x,circleMatrix[CircCenterCounter-rand1].vars.y,circleMatrix[CircCenterCounter-rand2].vars.x,circleMatrix[CircCenterCounter-rand2].vars.y).stroke(colors[i % 7])
}
}
}
...
for (var j = 0; j < r.height / 20; j++) {
    for (var i = 0; i < 24; i++) {
        ...
        RowofSquares(50 * i, 50 * j, Rune.random(squareWidthoptions.length), 50, rectBandGroup);
...
function Circle1(parent, num) {
    ...
    if (parent == mainchartgroup1) {
        ...
        r.line(dots[1].vars.x, dots[1].vars.y, dots[0].vars.x, dots[0].vars.y, mainchartgroup1).stroke(lineCol);
        r.line(dots[0].vars.x, dots[0].vars.y, dots[3].vars.x, dots[3].vars.y, mainchartgroup1).stroke(lineCol);

        r.line(dots[5].vars.x, dots[5].vars.y, dots[2].vars.x, dots[2].vars.y, mainchartgroup1).stroke(lineCol);
        r.line(dots[2].vars.x, dots[2].vars.y, dots[4].vars.x, dots[4].vars.y, mainchartgroup1).stroke(lineCol);
        r.line(dots[5].vars.x, dots[5].vars.y, dots[4].vars.x, dots[4].vars.y, mainchartgroup1).stroke(lineCol);
