...
//////◆ ◆ ◆ ◆ ◆ ◆ ◆ ◆ ◆ ◆ ◆ ◆ ◆ ◆ ◆//////
var jpg = new Rune.Pixels("assets/logoRef.jpg");
var oneMagRad = 20;
var topoffset = 25;
var magLine;
...
var BowTieX2 = Math.floor(Math.random() * (rw / oneMagWidth) - 0)
var BowTieY2 = Math.floor(Math.random() * (rh / oneMagWidth) - 0)
console.log(BowTieX, BowTieY,BowTieX2, BowTieY2)
GridofSearches(BowTieX, BowTieY,BowTieX2, BowTieY2);


function GridofSearches(BowTieX, BowTieY,BowTieX2, BowTieY2) {

    // if ((i !== BowTieX && j !== BowTieY) || (i !== BowTieX2 && j !== BowTieY2)) {
        for (var j = 0; j < rh / oneMagWidth; j++) {
            for (var i = 0; i < rw / oneMagWidth; i++) {
                ...
                if (i == BowTieX2 && j == BowTieY2) {
                    var randIndex = Math.floor(Math.random() * 5 - 0);

                    PlaceOneBowTie2(topoffset+i * oneMagWidth, topoffset+oneMagWidth * j, randIndex)
                }
            }
        }
    // }
...
function PlaceOneBowTie(xpos, ypos, colorIndex) {
    ...
    //   $("#bow-tie2").attr('fill', colorsHex[colorIndex]);
    // $("#bow-tie2").css({ width: 300,height: 300 });
    // $("#bow-tie2").css({ top: ypos - 30, left: xpos - 30 });
...
function PlaceOneBowTie2(xpos, ypos, colorIndex) {
    // $("#bow-tie").attr('fill', colorsHex[colorIndex]);
    // $("#bow-tie").css({ width: 300,height: 300 });
    // $("#bow-tie").css({ top: ypos - 30, left: xpos - 30 });
      $("#bow-tie2").attr('fill', colorsHex[colorIndex]);
